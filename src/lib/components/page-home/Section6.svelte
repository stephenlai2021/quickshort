...
<section
  class="section6 bg-[url()] bg-no-repeat bg-[bottom_left] max-[680px]:mx-[10px] max-[680px]:px-[10px] rounded-[20px] mt-[90px] mb-[80px] mx-[40px] sm:mx-[90px] border border-[2px] border-neutral/30"
>
